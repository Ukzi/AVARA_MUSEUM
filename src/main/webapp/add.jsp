		...
		<form name="frm" action="insert" method="post">
			...
			<div class="wrapper">
				<table>
					...
					<tr>
						<th>Payment</th>
						<td class="sv"><label>On-site</label> <input type="radio"
							name="r_confirm" value="Y"> <label>Make a deposit</label>
							<input type="radio" name="r_confirm" value="N"></td>
					</tr>
					<tr>
						<td colspan="2">
							<button class="btn" type="submit"
								onclick="fn_submit(); return false;">Reservation</button>
